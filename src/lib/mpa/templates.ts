...
export const INDUSTRY_TEMPLATES: IndustryTemplate[] = [
  {
    id: "fleet-management", label: "Fleet Management", entity: "Fleet Management E-commerce",
  ...
  {
    id: "grocery", label: "Grocery / Fresh Food", entity: "Grocery E-commerce",
  ...
  {
    id: "medical", label: "Medical Device", entity: "Bio-Medical Device Distributor",
  ...
  {
    id: "realestate", label: "Real Estate SaaS", entity: "Commercial Real Estate SaaS",
  ...
  {
    id: "automotive", label: "Automotive Parts", entity: "OEM Automotive Parts Marketplace",
  ...
  {
    id: "energy", label: "Energy / Industrial", entity: "Industrial IoT Asset Platform",
  ...
  {
    id: "fintech", label: "FinTech Banking", entity: "Digital Banking Platform",
  ...
  {
    id: "edtech", label: "EdTech LMS", entity: "AI-Powered Learning Management System",
  ...
  {
    id: "healthtech", label: "HealthTech Telemedicine", entity: "Telemedicine & Remote Patient Monitoring",
  ...
  {
    id: "ecommerce", label: "E-Commerce Marketplace", entity: "Multi-Vendor E-Commerce Marketplace",
  ...
  {
    id: "analytics", label: "SaaS Analytics", entity: "Real-Time SaaS Analytics Dashboard",
  ...
  {
    id: "devops", label: "DevOps Platform", entity: "CI/CD Pipeline Management Platform",
...
export const DOMINANCE_PROTOCOLS = [
  ...
  { id: "graphql",      label: "GraphQL (Sovereign)",        description: "Query-driven API with type safety" },
  { id: "event-driven", label: "Event-Driven CQRS",          description: "Command Query Responsibility Segregation with event sourcing" },
  { id: "hybrid",       label: "Hybrid Multi-Protocol",      description: "Combine REST + WebSocket + GraphQL for maximum coverage" },
];

export const AI_MODELS = [
  { id: "llama3-70b-8192",    label: "LLaMA 3 70B",   speed: "Powerful",  provider: "groq"   },
  { id: "llama3-8b-8192",     label: "LLaMA 3 8B",    speed: "Fastest",   provider: "groq"   },
  { id: "mixtral-8x7b-32768", label: "Mixtral 8x7B",  speed: "Balanced",  provider: "groq"   },
  { id: "gemma2-9b-it",       label: "Gemma 2 9B",    speed: "Efficient", provider: "groq"   },
  { id: "gpt-4o-mini",        label: "GPT-4o Mini",   speed: "Fast",      provider: "openai" },
  { id: "gpt-4o",             label: "GPT-4o",        speed: "Powerful",  provider: "openai" },
];
